...
cl = LINETCR.LINE()
cl.login(token="EslU5gfFWNqpBk7VSCx0.OKWky3kb60pcfWQ/EMbTGa.WK91JoN10T9s1aVklrxNfdKAa/MDgzG6ufcW1w1wUZY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Et1f3lq2D3ftECq6GI88.Gmmj/LDUVq+s+BNzSshgka.NeS57OMYceZ3HWjQVN7V0YQX5RCNjNwsZDzU8mYRN6k=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EtdT0MstJtm9dT57vKu7.v3sqF3OksXegXM+EfPH9zW.Zhbqy2v4ZGuuAjiA5+PLkOPqI1piv6X0y3+let0B6p4=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EtUuvpjPdiG9dCLmE768.yeSQbxo7cXfs/8+AYJ/ZIa.NHaQaijgaGKE/nBfaNIr2HUiwsSRXsN4WZh0qT/GehI=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="EtcPzzOcqBhPiWiWHlp0.rGm4bkvTi4OPdlfDXCAQ8a.J4BNnc4jZTTDke8POLti95/QAX8LhgXv7sS75lyVZxE=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="EtftrVINgxEvyYBScmj2.WXc/TGGn50c8rn8CNUdgKG.QL25+SgASVfaLDJN6Ey5uGwTISYBZdymJQ3Mf+9suyE=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Etw57Q5pxo0fzebODq5e.VCIFlyVTogKKOPyvujzLZG.BDC7Vfxtby6jWwhVheQe73YvQaBP/FKQrOvqU/XH34o=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="EtSaTLo7JI4w8jMtetKf.+ABCeSB6EIds4PgV4UGaRW.+hZ0GYBrDKMXvAbW8Iy9QUzpSXHsOrI0Ufq42SKcs8M=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EtpgMAvpolb0CEsQXhCc.8mbU9Qs9MrmxwvuNXICTda.FDqN3m6PZr73xFmTiXMeI/CxmTpuCVSxoGSHn11PQ9k=")
kh.loginResult()

kq = LINETCR.LINE()
kq.login(token="EtLE8GrMuy28SuLdYk4e.zieevjMpKYrx8lPQ/O4TxG.MddTEad42l9+9knd0V1Bqr7jM5HCrj6MEB9gqJlue7g=")
kq.loginResult()

ks = LINETCR.LINE()
ks.login(token="EtbkiQKsz8xO2JwLs751.QLyVrn/7ce0rYYmzu5Bcyq.bfXafRUsRSK9WfQU4cyaMN1F8unhKQTCMcyZfT1wTRc=")
ks.loginResult()

sw = LINETCR.LINE()
sw.login(token="Etqbyc5q7IOCYQt3Rp14.8NaIvlVRBSw74cWPQHDi5a.dlR3cQ75NRR+A/2DuIf8ZkE1q0C493QxgRfK4wDthFc=")
sw.loginResult()
...
╠ 🔰👻Ghost link 「on / off」
╠ 🔰👻Sablenk play 「Cleanse this group」
╠ 🔰👻Clearall 「Cleanse group」
╠ 🔰👻S ban 「BL all member」
╠ 🔰👻S del 「Unban all member」
...
KAC=[cl,ki,kk,kc,kb,kd,ke,kg,kh,kq,ks,sw] 
...
Imid = kq.getProfile().mid
Jmid = ks.getProfile().mid
Kmid = sw.getProfile().mid 
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,"u80c309fa576ebd0fd2fdb9d9b121c628","uf50d888821632d32461e37153ac775c0"]
admin = ["ua24c0a637281eb43c2170abe7a606d80","uf50d888821632d32461e37153ac775c0","u0fff0333558535e9cdbe1df7fad7e72b","u479ac059fe16c72a87bee2d0901e8c3f"]
staff = ["ua24c0a637281eb43c2170abe7a606d80","uf50d888821632d32461e37153ac775c0","u0fff0333558535e9cdbe1df7fad7e72b","u479ac059fe16c72a87bee2d0901e8c3f"]
owner =["ua24c0a637281eb43c2170abe7a606d80"]
adminMID = 'ua24c0a637281eb43c2170abe7a606d80','uf50d888821632d32461e37153ac775c0','u0fff0333558535e9cdbe1df7fad7e72b','u479ac059fe16c72a87bee2d0901e8c3f'
wait ={ 
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks for add Created by Genta",
    "lang":"JP",
    "comment":"BOTS SABLENK  TEAM •\n\nsKilers:\n[☆] Genta [☆]\n[✯]  ",
    "likeOn":True,
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
...
#--------------------------------------------------------------------------------------------
        if op.type == 19:
                ...
                if not op.param2 in Bots:
                  if wait["Backup"] == True:
                    try:
                        klist=[ki,kk,kc,kd,kb,ke,kg,kh,kq,ks,cl]
...
#                if not op.param2 in Bots:
 #                if op.param2 not in Bots:
  #                if wait["protect"] == True:
   #                try:
    #                   klist=[cl,ki,kk,kc,kb,kd,ke,kg,kh,cl]
     #                  kicker=random.choice(klist)
      ...
      #                 G = kicker.getGroup(op.param1)
       #                G.preventJoinByTicket = False
        #               kicker.updateGroup(G)
         #              invsend = 0
          #             Ticket = kicker.reissueGroupTicket(op.param1)
           #            kc.acceptGroupInvitationByTicket(op.param1,Tibcket)
            #           X = kicker.getGroup(op.param1)
             #          X.preventJoinByTicket = True
  ...
  #                     kicker.updateGroup(X)
                ...
                if not op.param2 in Bots:
                 if op.param2 not in Bots:
                  if wait["protect"] == True:
                   try:
                       klist=[cl,ki,kk,kc,kb,kd,ke,kg,kh,kq,ks,cl]
                       kicker=random.choice(klist)
                       G = kicker.getGroup(op.param1)
                       G.preventJoinByTicket = False
                       kicker.updateGroup(G)
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 cl.sendText(msg.to,"Call my genta to use command !, \n➡Unban: " + invite)
                                 break
                             else:
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 ki.sendText(msg.to,"Call my genta to use command !, \n➡ Unban: " + invite)
                                 break
                             else:
                                 targets.append(invite)
                         if targets == []:
...
#---------------------------------------------------------------------------------------------
		...
		if wait["Protectgroupname"] == False:
			...
			cl.sendText(msg.to,"Gnamelock already off")
#---------------------------------------------------------------------------------------------
	    elif msg.text in ["Siri on","S on","Kojom on"]:
	      if msg.from_ in admin:
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"On")
#-----------------------------------------------------------------------------------------
            elif msg.text in ["Siri off","S off","Kojom off"]:
              if msg.from_ in admin:
...
#-----------------------------------------------                   
	      ...
	      if msg.from_ in admin:
                  ...
                  print "COMMENT DENIED"
#-----------------------------------------------
	    elif msg.text in ["Mek","Tagall","Sablenk"]:
	      if msg.from_ in admin:
                group = cl.getGroup(msg.to)
...
#-----------------------------------------------------------------------
	    ...
	    elif "S del" in msg.text:
	      if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Blacklist user succes dibersihkan")

            elif "S ban" in msg.text:
              if msg.toType == 2:
                  if msg.from_ in admin:                                        
                       ban0 = msg.text.replace("S ban","")
                       ban1 = ban0.lstrip()
                       ban2 = ban1.replace("@","")
                       ban3 = ban2.rstrip()
                       _name = ban3
